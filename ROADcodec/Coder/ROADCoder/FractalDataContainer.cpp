...
ROADEncoding::IDoubleDataContainer* ROADEncoding::FractalDataContainer::getAver() {
    return this->_averContainer;
}

ROADEncoding::IDoubleDataContainer* ROADEncoding::FractalDataContainer::getExtendAver() {
    return this->_extenAverContainer;
}

ROADEncoding::IUCharDataContainer* ROADEncoding::FractalDataContainer::getIndex() {
    return this->_indexContainer;
}

ROADEncoding::IUCharDataContainer* ROADEncoding::FractalDataContainer::getDomain() {
    return this->_domainContainer;
}

ROADEncoding::IUCharDataContainer* ROADEncoding::FractalDataContainer::getScale() {
    return this->_scaleContainer;
}

ROADEncoding::FractalDataContainer::FractalDataContainer(unsigned int aSize)
...
ROADEncoding::FractalDataContainer::~FractalDataContainer()
{
...
void ROADEncoding::FractalDataContainer::populate(ROADEncoding::FrameFractalItemCollection* aCollection)
{
...
void ROADEncoding::FractalDataContainer::reset()
{
