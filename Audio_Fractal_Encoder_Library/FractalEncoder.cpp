...
FractalEncoding::IFractalDataContainer* FractalEncoding::FractalEncoder::encode(double* aData) {
...
void FractalEncoding::FractalEncoder::silenceMatch(double* aData, unsigned int aSilenceSampleLength, FractalEncoding::IFrameFractalItemCollection* aPtrFrameFractalItemCollection) {
...
void FractalEncoding::FractalEncoder::rangeMatch(double* aData, unsigned int aRangeLength, unsigned int aDeepthIndex, FractalEncoding::IFrameFractalItemCollection* aPtrFrameFractalItemCollection) {
...
double FractalEncoding::FractalEncoder::computeSumValue(double* aData, unsigned int aLength) {
...
double FractalEncoding::FractalEncoder::computeDeviationValue(double* aData, unsigned int aLength, double aAverValue) {
...
void FractalEncoding::FractalEncoder::populateDomainPools(double* aData)
{
    for(FractalEncoding::DomainPool* item: _domainPools)
         item->populate(aData);
}

FractalEncoding::FractalEncoder::FractalEncoder(FractalEncoding::FractalEncodingOptions aOptions)
    : _options(aOptions)
{
    _superFrameFractalItemCollections.push_back(
                new FractalEncoding::SuperFrameFractalItemCollection(aOptions.getSuperFrameLength(),
        ...
        ++index)
    {
        ...
        _domainPools.push_back( new FractalEncoding::DomainPool(lDomainPoolSize, lTopDomainLength, aOptions.getDomainShift()));
    }
...
FractalEncoding::FractalEncoder::~FractalEncoder()
{
    for(FractalEncoding::SuperFrameFractalItemCollection* item: _superFrameFractalItemCollections)
        delete item;
...
double FractalEncoding::FractalEncoder::computeAlpha(const double* aDataRang,
