...
FractalDecoding::DomainProcessor::DomainProcessor(unsigned int aMaxLength)
    : _data(new double [aMaxLength])
{
}

FractalDecoding::DomainProcessor::~DomainProcessor()
{
    delete []_data;
}

double* FractalDecoding::DomainProcessor::process(double* aData, unsigned int aLength, unsigned int aSamplePerRange, unsigned int aDomainIndex, unsigned int aRelativeDomainSfift, unsigned int aScaleDomainShift, bool aForwardDirection) {
...
void FractalDecoding::DomainProcessor::backShrink(double* aData, unsigned int aLength, unsigned int aRelativeDomainSfift, unsigned int aScaleDomainShift) {
